...
public class PopularTopicsFragment extends Fragment implements TopicsAdapter.TopicExpandedOptionsListener {
    ...
    private void listenForPopularTopicsFromServer() {
        childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                mAdapter.notifyItemInserted(mAdapter.getTopicModels().indexOfKey(key));
            }
...
//                TopicModel model = dataSnapshot.getValue(TopicModel.class);
        ...
        refs.orderByChild("popular").equalTo(true).addChildEventListener(childEventListener);
    }
